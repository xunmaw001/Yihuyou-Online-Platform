  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.22);borderRadius:10px">
        <h1 class="h1" style="color:rgba(104, 223, 240, 1);fontSize:28px;">亿互游在线平台网站注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="地址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.dizhi" autocomplete="off" placeholder="地址" type="text" />
																																	...
																																	<!-- <div v-if="tableName=='qiantai'" class="input-group">
			   <div class="label">前台账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qiantaizhanghao" class="input" type="text" placeholder="前台账号">
			   </div>
			 </div> -->
			<el-form-item label="前台账号" class="input" v-if="tableName=='qiantai'">
			  <el-input v-model="ruleForm.qiantaizhanghao" autocomplete="off" placeholder="前台账号" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='qiantai'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='qiantai'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='qiantai'" class="input-group">
			   <div class="label">前台姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.qiantaixingming" class="input" type="text" placeholder="前台姓名">
			   </div>
			 </div> -->
			<el-form-item label="前台姓名" class="input" v-if="tableName=='qiantai'">
			  <el-input v-model="ruleForm.qiantaixingming" autocomplete="off" placeholder="前台姓名" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='qiantai'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='qiantai'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='qiantai'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="地址" class="input" v-if="tableName=='qiantai'">
			  <el-input v-model="ruleForm.dizhi" autocomplete="off" placeholder="地址" type="text" />
			</el-form-item>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                              ...
                                                                              if((!this.ruleForm.qiantaizhanghao) && `qiantai` == this.tableName){
        this.$message.error(`前台账号不能为空`);
        return
      }
                                                                  if((!this.ruleForm.mima) && `qiantai` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
                                                                                                                                                                                                                                                            if(`qiantai` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
                                                                        if(`qiantai` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
                                                                                                                                                            if(`qiantai` == this.tableName && this.ruleForm.money&&(!this.$validate.isNumber(this.ruleForm.money))){
        this.$message.error(`余额应输入数字`);
        return
      }
                                                                                                                                                                                                                                    this.$http({
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210303/eeaeba60940f44cbb289ded0eb640ec9.jpg");
		height: 100vh;
