          ...
          <el-form-item class="input" label="起点" prop="qidian">
              <el-input v-model="ruleForm.qidian" 
                placeholder="起点" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="途经路段" prop="tujingluduan">
          <el-input v-model="ruleForm.tujingluduan" 
              placeholder="途经路段" clearable  :readonly="ro.tujingluduan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="途经路段" prop="tujingluduan">
              <el-input v-model="ruleForm.tujingluduan" 
                placeholder="途经路段" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="详细路线" prop="xiangxiluxian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="详细路线"
                  v-model="ruleForm.xiangxiluxian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xiangxiluxian" label="详细路线" prop="xiangxiluxian">
                    <span>{{ruleForm.xiangxiluxian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    jingdianmingchengChange () {
      this.$http({
        url: `follow/jingdianxinxi/jingdianmingcheng?columnValue=`+ this.ruleForm.jingdianmingcheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.jingdiandizhi){
                this.ruleForm.jingdiandizhi = data.data.jingdiandizhi
              }
                                                                                                                                                                                        } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `luxianguihua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.luxianguihuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
