          ...
          <el-form-item class="input" label="标题" prop="biaoti">
              <el-input v-model="ruleForm.biaoti" 
                placeholder="标题" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邀请时间" prop="yaoqingshijian">
          <el-input v-model="ruleForm.yaoqingshijian" 
              placeholder="邀请时间" clearable  :readonly="ro.yaoqingshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邀请时间" prop="yaoqingshijian">
              <el-input v-model="ruleForm.yaoqingshijian" 
                placeholder="邀请时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="邀请人" prop="yaoqingren">
          <el-input v-model="ruleForm.yaoqingren" 
              placeholder="邀请人" clearable  :readonly="ro.yaoqingren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="邀请人" prop="yaoqingren">
              <el-input v-model="ruleForm.yaoqingren" 
                placeholder="邀请人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaoqingshijian = true;
            continue;
	            	            ...
	            	            if(o=='yaoqingren'){
            this.ruleForm.yaoqingren = obj[o];
	    this.ro.yaoqingren = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yaoqingxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yaoqingxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
